...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	<head runat="server">
		...
		<meta charset="utf-8"/>
		<title>(Sync) Artist Details</title>
				...
				<div class="wrapper mod-standard mod-gray">
					<div class="details-banner">
						...
						<div class="details-banner--hero">
							<img class="details-banner--hero--img" src="<%=Artist.HeroURL %>" 
							srcset="<%=Artist.HeroURL%>, <%=Artist.HeroURL%> 2x" alt="<%=Artist.Title %>"/>
						</div>
						<div class="details-banner--info">
							<a href="#" class="details-banner--info--box">
									<img class="details-banner--info--box--img"
									 src="<%=Artist.ImageURL%>"
									 srcset="<%=Artist.ImageURL%>, <%=Artist.ImageURL%> 2x"
									 alt="alt"/>
							</a>
							<h1 class="details-banner--info--name"><a class="details-banner--info--name--link" href="#"><%=Artist.Title%></a></h1>
						</div>
					</div>
								...
								<main class="discovery--section">
									...
									<section class="standard--holder">
										...
										<ul id="playlist" class="song-list mod-new mod-menu">
											<asp:Repeater runat="server" ID="topSongInfo">
												<ItemTemplate>
													<li class="song-list--item media-player--row">

														<div class="song-list--item--player-img media-player">
															<img id="songImg" class="song-list--item--player-img--img" 
															srcset="<%#Albums.ContainsKey((int)Eval("AlbumID"))? Albums[(int)Eval("AlbumID")].ImageURL : ""%> 2x" 
															src="<%#Albums.ContainsKey((int)Eval("AlbumID"))? Albums[(int)Eval("AlbumID")].ImageURL : ""%>" 
																alt="<%#Albums.ContainsKey((int)Eval("AlbumID"))? Albums[(int)Eval("AlbumID")].Title : Eval("Title")%>"/>
														</div>

														<div class="song-list--item--right">

															<a href="#" class="song-list--item--primary"><%#Eval("Title") %></a>
															<a class="song-list--item--secondary"><%# Albums.ContainsKey((int)Eval("AlbumID"))? Albums[(int)Eval("AlbumID")].Title : Eval("Title")%></a>
															<a class="song-list--item--secondary"><%#Eval("Bpm", "{0:G29}") %> BPM</a>
															<a class="song-list--item--secondary"><%#Eval("TimeSignature") %></a>
															<div class="song-list--item--icon--holder">
															
																<a href="#" class="song-list--item--icon--wrap" style="<%# (bool)Eval("MultiTracks") == true? "display: inline-block": "display: none"%>">
																...
																<a href="#" class="song-list--item--icon--wrap" style="<%# (bool)Eval("CustomMix") == true? "display: inline-block": "display: none"%>">
																...
																<a href="#" class="song-list--item--icon--wrap" style="<%# (bool)Eval("RehearsalMix") == true? "display: inline-block": "display: none"%>">
																...
																<a href="#" class="song-list--item--icon--wrap" style="<%# (bool)Eval("Patches")||(bool)Eval("SongSpecificPatches") == true? "display: inline-block": "display: none"%>">
																...
																<a href="#" class="song-list--item--icon--wrap" style="<%# (bool)Eval("Chart") == true? "display: inline-block": "display: none"%>">
																...
																<a href="#" class="song-list--item--icon--wrap" style="<%# (bool)Eval("ProPresenter") == true? "display: inline-block": "display: none"%>">
										...
										<section class="standard--holder">
											...
											<div class="discovery--grid-holder">
												...
												<div class="ly-grid ly-grid-cranberries">
													<asp:Repeater runat="server" ID="albumInfo">
														<ItemTemplate>
															<div class="media-item">
																...
																<a runat="server" id="albumArtistTitle" class="media-item--subtitle" href="#" tabindex="0"><%=Artist.Title%></a>
															</div>
														</ItemTemplate>
													</asp:Repeater>
												</div><!-- /.grid -->
									...
									<section class="standard--holder">
										...
										<div runat="server" id="artistDetailsBio" class="artist-details--biography biography">
											<a href="#">Read More...</a>
										</div>
